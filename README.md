<p align="center">
  <img src="assets/banner.svg" alt="HyperOS 4 Houji Port Builder" width="100%">
</p>
...
В Git попадают только исходники builder, манифест хэшей, документация и маленькая графика. GitHub Actions дополнительно отклонит архив прошивки или любой отслеживаемый файл тяжелее 5 МБ.
